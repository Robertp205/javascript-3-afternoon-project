...
//Code Here
let evenNumbers = mixedNumbers.filter(function(e ,index, wholeArray){
  return e % 2 === 0
})
...
//Code Here
let postTaxPrices = prices.map((element, i, arr) => {
...
//Code Here
let totalPopulation  = populations.reduce(function(accum, element){
